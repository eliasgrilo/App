 ...
 * Now synced with Inventory data for consistency
 */
...
export default function Products() {
    // ═══════════════════════════════════════════════════════════════
    // STATE - Now using Inventory data directly
    // ═══════════════════════════════════════════════════════════════

    // Get inventory items via shared hook (synced with Inventory page)
    const inventoryItems = useInventoryItems()

    // Map inventory items to product format for display consistency
    ...
    // ═══════════════════════════════════════════════════════════════
    // CLOUD SYNC - Load suppliers only
    // ═══════════════════════════════════════════════════════════════
    useEffect(() => {
    ...
    // Note: Products page is now READ-ONLY view of Inventory data
    // To add/edit/delete products, use the Estoque (Inventory) page
                ...
                <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
                    <div>
                        ...
                        <p className="text-sm text-zinc-500 dark:text-zinc-400 font-medium">
                            Visualização sincronizada com Estoque
                        </p>
                    </div>
                    ...
                    <a
                        ...
                        onClick={(e) => {
                            e.preventDefault()
                            // Navigate to inventory section - find the nav and click Estoque
                            showToast('Use a página de Estoque para adicionar itens', 'info')
                        }}
                        className="w-full md:w-auto px-8 py-4 md:py-3.5 bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 rounded-2xl text-xs font-bold uppercase tracking-widest border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-all flex items-center justify-center gap-3"
                    >
            ...
            {filteredProducts.length === 0 && (
                ...
                >
                    ...
                    <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-6">
                        {searchQuery ? 'Tente uma busca diferente' : 'Adicione itens no Estoque para vê-los aqui'}
                    </p>
                </motion.div>
            )}
