// ═══════════════════════════════════════════════════════════════════
// ADD EXPENSE MODULE — Types, Icons, Constants
// ═══════════════════════════════════════════════════════════════════
...
export interface ExpenseFormData { description: string; amount: string; quantity: number | string; category: string; type: 'Fixo' | 'Variável'; link: string; date: string }
...
export const CategoryIcons: Record<string, React.ReactNode> = {
    'Maquinário': (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" /></svg>),
    'Insumos': (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" /><line x1="3" y1="6" x2="21" y2="6" /><path d="M16 10a4 4 0 0 1-8 0" /></svg>),
    ...
    'Marketing': (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg>),
    'Impostos': (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2" /><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" /></svg>),
    'Outros': (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="1" /><circle cx="12" cy="5" r="1" /><circle cx="12" cy="19" r="1" /></svg>)
}

export const CategoryColors: Record<string, { bg: string; glow: string }> = {
...
export const EXPENSE_TYPES = [{ id: 'Fixo', label: 'Fixo' }, { id: 'Variável', label: 'Variável' }]

export const DEFAULT_CATEGORIES: CategoryOption[] = [
    { id: 'maquinario', label: 'Maquinário' }, { id: 'insumos', label: 'Insumos' },
    { id: 'operacional', label: 'Operacional' }, { id: 'marketing', label: 'Marketing' },
    { id: 'impostos', label: 'Impostos' }, { id: 'outros', label: 'Outros' }
]
