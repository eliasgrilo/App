...
// NameInput
export interface NameInputProps { value: string; onChange: (e: ChangeEvent<HTMLInputElement>) => void; placeholder?: string; autoFocus?: boolean; inputRef?: React.RefObject<HTMLInputElement | null> }
export function NameInput({ value, onChange, placeholder, autoFocus, inputRef }: NameInputProps) {
