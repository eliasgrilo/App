...
type AccentColor = 'indigo' | 'emerald' | 'violet' | 'amber' | 'rose'
type MetricSize = 'sm' | 'md' | 'lg' | 'xl'
type MetricColor = 'default' | 'accent'
type StatColor = 'zinc' | 'indigo' | 'emerald' | 'amber' | 'rose'
type ProgressColor = 'indigo' | 'emerald' | 'violet' | 'amber' | 'orange' | 'rose'

interface AppleCardProps extends Omit<HTMLMotionProps<'div'>, 'onClick'> {
    children?: ReactNode
    radius?: RadiusSize
    padding?: PaddingSize
    variant?: CardVariant
...
const CardFooter: React.FC<CardFooterProps> = ({
    ...
    return (
        <div className={`
            ...
            border-t border-zinc-100/80 dark:border-white/5
            ${className}
        `}>
            {children}
        </div>
...
const AppleCard = Object.assign(AppleCardComponent, {
    Header: CardHeader,
    Metric: CardMetric,
    Footer: CardFooter,
    Stat: CardStat,
