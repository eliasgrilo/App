...
const AppleConfirmModal: React.FC<AppleConfirmModalProps> = ({
    isOpen = false,
        ...
        <AnimatePresence>
            ...
            >
                ...
                <motion.div
                    ...
                    transition={MODAL_ANIMATIONS.springGentle}
                ...
                >
                    ...
                    <div className="px-6 py-6 md:px-8 md:py-8">
                        ...
                        {/* Title */}
                        <h3 id="modal-title" className="text-xl font-bold text-zinc-900 dark:text-white text-center mb-3 tracking-tight">
                            {title}
                        </h3>

                        {/* Message */}
                        <p id="modal-description" className="text-sm text-zinc-600 dark:text-zinc-400 text-center leading-relaxed">
                            {message}
                        </p>
                    </div>
                    ...
                    <div className="border-t border-zinc-200/80 dark:border-white/10">
                        ...
                        <button
                            ...
                            aria-label={isDangerous ? `${confirmLabel} - ação destrutiva` : confirmLabel}
                            className={`w-full px-6 py-4 text-base font-semibold border-b border-zinc-200/80 dark:border-white/10 hover:bg-zinc-50 dark:hover:bg-white/5 active:bg-zinc-100 dark:active:bg-white/10 transition-all duration-[250ms] ${isDangerous
                        ...
                        <button
                            ...
                            className="w-full px-6 py-4 text-base font-medium text-zinc-600 dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-white/5 active:bg-zinc-100 dark:active:bg-white/10 transition-all duration-[250ms]"
                        >
                            {cancelLabel}
                        </button>
                    </div>
