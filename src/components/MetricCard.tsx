...
type AccentColor = 'indigo' | 'emerald' | 'violet' | 'amber' | 'orange' | 'rose'
...
const AnimatedNumber: React.FC<AnimatedNumberProps> = ({ value, formatFn, duration = 1 }) => {
...
const StatusDot: React.FC<StatusDotProps> = ({ status = 'active', pulse = false }) => {
            ...
            <div>
                ...
                `}>
                    {animated && typeof value === 'number' ? (
                        <AnimatedNumber value={value} formatFn={formatFn as ((value: number) => string) | undefined} />
                    ) : (
...
const MetricCard = Object.assign(MetricCardComponent, {
    Grid: MetricGrid,
    Hero: MetricHero
})
