/**
 * Modal Icons — Premium SF Symbol-style SVG icons
 */
...
// Gradient backgrounds for section icons
export const iconGradients: Record<string, string> = {
    ...
    rating: 'linear-gradient(135deg, #FFD60A 0%, #FF9F0A 100%)',
    category: 'linear-gradient(135deg, #34C759 0%, #30D158 100%)',
    unit: 'linear-gradient(135deg, #007AFF 0%, #5AC8FA 100%)',
    price: 'linear-gradient(135deg, #FF9500 0%, #FFCC00 100%)',
    stock: 'linear-gradient(135deg, #5856D6 0%, #AF52DE 100%)',
    expiry: 'linear-gradient(135deg, #FF2D55 0%, #FF6482 100%)'
}
...
export const shadowColors: Record<string, string> = {
    ...
    category: 'rgba(52,199,89,0.4)',
    unit: 'rgba(0,122,255,0.4)',
    price: 'rgba(255,149,0,0.4)',
    stock: 'rgba(88,86,214,0.4)',
    expiry: 'rgba(255,45,85,0.4)'
}
