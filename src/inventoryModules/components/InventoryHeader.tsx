        ...
        <div className="relative z-20 flex flex-col md:flex-row md:items-end justify-between gap-6 mb-2">
            <div>
                <div className="flex items-center gap-3 mb-1">
                    ...
                    {/* Alerts Badge */}
                    {totalAlertCount > 0 && (
                        <div className="mt-2 px-2.5 py-0.5 rounded-full border flex items-center gap-1.5 transition-all duration-500 bg-amber-500/5 border-amber-500/10 text-amber-500">
