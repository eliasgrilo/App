                        ...
                        <div className="px-7 pt-7 pb-4">
                            <div className="flex items-center justify-between gap-4">
                                <div className="flex-1 min-w-0">
                                    <motion.h2 initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-xl font-semibold text-zinc-900 tracking-tight leading-none">Níveis</motion.h2>
                                ...
                                <div className="flex items-center gap-2">
                                        ...
                                        {isFocused ? (
                                            ...
                                            >
                                                <input
                                                    ...
                                                    className="w-full pl-3 pr-8 py-1.5 rounded-lg text-[12px] text-zinc-800 font-medium bg-white/90 placeholder:text-zinc-300 focus:outline-none border border-zinc-200/60 focus:border-indigo-200/60"
                                                />
                                    ...
                                    <motion.div whileHover={{ scale: 1.03 }} className="px-3 py-1.5 rounded-lg" style={{ background: 'rgba(99,102,241,0.06)', boxShadow: '0 0 0 1px rgba(99,102,241,0.08) inset' }}>
                                        <span className="text-[11px] font-semibold text-indigo-600 tabular-nums">{items.length}</span>
