...
export const ToastContainer: React.FC<ToastContainerProps> = ({ toasts, onDismiss }) => {
    ...
    return createPortal(
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-[9999] w-full max-w-sm px-4 pointer-events-none" role="region" aria-label="Notificações" aria-live="polite">
